...
class FeatureusagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create featureusage' do
    assert_difference('Featureusage.count') do
      post featureusages_url,
           params: { featureusage: { buyer_id: @featureusage.buyer_id, feature_id: @featureusage.feature_id,
                                     # rubocop:todo Layout/LineLength
                                     is_used: @featureusage.is_used, total_extra_units: @featureusage.total_extra_units } }
  ...
  test 'should update featureusage' do
    patch featureusage_url(@featureusage),
          params: { featureusage: { buyer_id: @featureusage.buyer_id, feature_id: @featureusage.feature_id,
                                    # rubocop:todo Layout/LineLength
                                    is_used: @featureusage.is_used, total_extra_units: @featureusage.total_extra_units } }
    # rubocop:enable Layout/LineLength
